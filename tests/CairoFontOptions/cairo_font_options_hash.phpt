...
CAUGHT ERROR: Argument 1 passed to cairo_font_options_hash() must be an instance of CairoFontOptions, integer given

Warning: cairo_font_options_hash() expects parameter 1 to be CairoFontOptions, integer given in %s on line %d