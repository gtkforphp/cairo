...
CAUGHT ERROR: Argument 1 passed to cairo_in_stroke() must be an instance of CairoContext, integer given

Warning: cairo_in_stroke() expects parameter 1 to be CairoContext, integer given in %s on line %d
