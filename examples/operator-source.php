...
function set_translucent_pattern ($x, $y)
{
    global $con;
...
function set_surface_pattern($x, $y)
{
	global $con,$sur,$width,$height;
	$wi = floor(0.6*$width);
	$he = floor(0.6*$height);
	$x+=0.2 * $width;
	$y+=0.2 * $height;
	$s = $sur->createSimilar(CairoContent::COLOR_ALPHA, $wi, $he);
