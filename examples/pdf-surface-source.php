...
$size = 90;
$sur = new CairoPDFSurface("pdf-surface-source.pdf", $size, $size);
...
$s = new CairoPDFSurface("temp.pdf", $surface_size, $surface_size);
draw_pattern($surface_size);
$s->writeToPng(dirname(__FILE__)  . "/temp1.png");
$con->setSourceSurface($s, 15.0, 15.0);
$con->paint();
$sur->writeToPng(dirname(__FILE__)  . "/pdf-surface-source-php.png");
?>
