...
PHP_METHOD(CairoFontFace, __construct)
{
	...
	php_error(E_ERROR,"Please use Context.get_font_face()");
}
/* }}} __construct */
...
PHP_METHOD(CairoFontOptions, getAntialias)
{
    ...
    fontoptions_object *curr = (fontoptions_object *)zend_objects_get_address(_this_zval TSRMLS_CC);
	x = cairo_font_options_get_antialias(curr->fontoptions);
...
PHP_METHOD(CairoFontOptions, getHintMetrics)
{
	...
	x = cairo_font_options_get_hint_metrics(curr->fontoptions);
	RETURN_LONG(x);
}
/* }}} getHintMetrics */
...
PHP_METHOD(CairoFontOptions, getHintStyle)
{
	...
	x = cairo_font_options_get_hint_style(curr->fontoptions);
	RETURN_LONG(x);
}
/* }}} getHintStyle */
...
PHP_METHOD(CairoFontOptions, getSubpixelOrder)
{
	...
	x = cairo_font_options_get_subpixel_order(curr->fontoptions);
	RETURN_LONG(x);
}
/* }}} getSubpixelOrder */
...
PHP_METHOD(CairoFontOptions, setAntialias)
{
	...
	phpCAIRO_FONTOPTIONS_ERROR(curr->fontoptions);
...
PHP_METHOD(CairoScaledFont, extents)
{
	...
	phpCAIRO_SCALEDFONT_ERROR(curr->scaledfont);
